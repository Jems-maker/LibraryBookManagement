    ...
    return (
        <div className="space-y-6">
                            ...
                            {isLoading ? (
                                ...
                                <tr key={author.id} className="hover:bg-gray-50/50">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button onClick={() => openModal(author)} title="Edit" className="p-2 rounded-lg bg-white text-blue-600 border border-gray-200 hover:bg-blue-50 hover:border-blue-300 transition-colors">
                                        ...
                                        <button onClick={() => setDeleteTarget(author)} title="Delete" className="p-2 rounded-lg bg-white text-red-600 border border-gray-200 hover:bg-red-50 hover:border-red-300 transition-colors">
            ...
            <ConfirmModal
                isOpen={!!deleteTarget}
                title="Delete Author"
                message={`Are you sure you want to delete ${deleteTarget?.name ?? 'this author'}? This action cannot be undone.`}
            ...
            <div className="bg-white rounded-3xl max-w-md w-full shadow-2xl overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea rows={3} value={formData.bio} onChange={e => setFormData({ ...formData, bio: e.target.value })} className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500" placeholder="Optional"></textarea>
                    </div>
